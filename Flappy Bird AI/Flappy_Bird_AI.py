...
BIRD_IMGS = [pygame.transform.scale2x(pygame.image.load(os.path.join("Flappy Bird AI","imgs","bird1.png"))),pygame.transform.scale2x(pygame.image.load(os.path.join("Flappy Bird AI","imgs","bird2.png"))), pygame.transform.scale2x(pygame.image.load(os.path.join("Flappy Bird AI","imgs","bird3.png")))]
